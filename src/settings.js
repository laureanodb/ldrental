...
const DEFAULTS = { avisoWarn: 15, avisoSoft: 30, depositoAvisoPct: 50, multaUmbral: 500000, multaPlazoDias: 7, kmSemanaEsperado: 1500, fotoControlDias: 30, companyName: 'LD Rental', companyLogo: '', companyPhone: '', bonoSemanas: 8, riesgoSemanas: 2, multaRecargoPct: 10, puntosLimite: 20, puntosVigenciaMeses: 24, autoParadoDias: 14, panelKpis: ['cobrado', 'esperado', 'deuda', 'saldoFin', 'autosCalle', 'vencUrgentes', 'autosDisponibles'] };
