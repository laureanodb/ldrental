...
export function viewSetup() {
  return '<div class="login"><h1>Mi Flota v2</h1><div class="card"><b>Falta configurar la conexión</b><p class="small muted">Completá VITE_SUPABASE_URL y VITE_SUPABASE_KEY en el archivo .env, con los datos de tu proyecto de Supabase.</p></div></div>';
}
export function viewLogin() {
  return '<div class="login"><h1>Mi Flota v2</h1><p class="sub">Ingresá con tu usuario</p>' +
