...
export const ui = { tab: 'panel', qCars: '', qDrivers: '', filterCar: '', showVendidos: false, showInactivos: false, showProspectos: false, qMant: '', mantProveedor: '', mantDesde: '', mantHasta: '', mantAuto: '', mantItem: '', mantTipo: '', mantOrden: 'fecha', ordenAutos: 'patente', ordenChoferes: 'nombre', filtroAutoTipo: '', filtroCobrosMetodo: '', showDesgloseCobrado: false, ordenCompChoferes: 'antiguedad', ordenCompAutos: 'neta' };
