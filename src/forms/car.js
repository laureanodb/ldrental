...
import { isContract, calc, finFinanciado, driverName } from '../calc.js';
...
export function carForm(id) {
  ...
  if (ex) {
    ...
    h += '<div class="sec-t row between">Gastos y mantenimiento<span class="small muted">' + money(totalGastos) + ' en total</span></div>';
